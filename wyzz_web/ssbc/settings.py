...
#EMAIL_HOST_USER = 'wowo@cilibaba.com'
#EMAIL_HOST_PASSWORD = '_need_to_set_this_in_deployment.py'
#DEFAULT_FROM_EMAIL = 'www <noreply@woyaozhongzi.com>'
#EMAIL_USE_SSL = True
#EMAIL_PORT = 465
#SERVER_EMAIL = 'www@www.com'
